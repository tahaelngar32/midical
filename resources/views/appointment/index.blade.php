...
<div id="appointmentsManageList" class="appointments-manage-list">
  ...
  <article class="manage-row" data-search="{{ $patient->first_name }} {{ $patient->last_name }} follow-up diabetes management in progress" data-status="in-progress">
    <div class="manage-main">
      <div class="appointment-avatar">MC</div>
      <div>
        <div class="flex flex-wrap items-center gap-2">
          <h4 class="manage-name">{{ $patient->first_name }} {{ $patient->last_name }}</h4>
